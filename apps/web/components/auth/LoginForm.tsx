  ...
  return (
    <div className="flex flex-col min-h-screen w-full items-center justify-center bg-transparent py-4 px-2">
      ...
      <div className="bg-mainred-blur w-full max-w-sm mx-auto px-2 sm:px-0 rounded-2xl overflow-hidden shadow-lg flex flex-col items-center">
        <div className="w-full flex flex-col items-center px-4 py-6 sm:px-8 sm:py-10 gap-4 sm:gap-6">
          {/* Logo lớn & đẹp */}
          <Image
            src="/logo_white.png"
            alt="VLU Logo"
          ...
          <div className="flex items-center w-full gap-2 my-2 sm:my-3">
            ...
            <p className="px-2 text-custom-white/80 text-center text-sm sm:text-base leading-snug font-light">
              Vui lòng sử dụng tài khoản Microsoft<br />
              chính thức do nhà trường cấp để<br className="sm:hidden" /> đăng nhập.
            </p>
            <div className="h-px flex-1 bg-white/30 rounded-full max-w-[40px] sm:max-w-[60px]" />
          </div>
